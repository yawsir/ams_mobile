        ...
        <div class="info-box">
            ...
            <div class="info">
                <p class="row">
                    ...
                    <span>{{teacherInfo.teacher_gender ? '男' : '女'}}</span>
                </p>
                <p class="row">课程号：{{teacherInfo.teacher_subject_id}} 课程名：{{teacherInfo.teacher_subject_name}}</p>
                <p class="row">人数:{{teacherInfo.teacher_subject_current}}/{{teacherInfo.teacher_subject_max}}</p>
            </div>
        </div>
...
export default {
    ...
    methods: {
        //查询信息
        queryTeacherInfo(teacher_id){
            this.$http.get(`${config.apiAddr}/teacher/queryTeacherInfo?teacher_id=${teacher_id}`)
            .then(res => {
                console.log(res)
                if(res.data.success){
        ...
        modifyPwd(){
            ...
            if(str === ''){
                this.$http.post(`${config.apiAddr}/teacher/modifyPwd`, {
    ...
    mounted() {
        ...
        this.queryTeacherInfo(this.teacher_id)
    },
    components: {
        MyDialog
    }
